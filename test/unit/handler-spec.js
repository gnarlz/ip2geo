...
const validateErrorResponse = (response) => {
    ...
    expect(response.headers["X-Requested-With"]).to.be.ok
    expect(response.headers["Access-Control-Allow-Headers"]).to.be.ok
    expect(response.headers["Access-Control-Allow-Origin"]).to.be.ok
    expect(response.headers["Access-Control-Allow-Methods"]).to.be.ok
    expect(response.body).to.be.ok
    expect(response.body.status).to.equal('error')
    expect(response.body.request).to.be.ok
    expect(response.body.request.request_id).to.be.ok
    expect(response.body.status_code).to.be.ok
    expect(response.body.status_code).to.not.equal(200)
    expect(response.body.error).to.be.ok
    expect(response.body.error.message).to.be.ok
    expect(response.body.error.code).to.be.ok
...
const validateSuccessResponse = (response) => {
    ...
    expect(response.body.request).to.be.ok
    expect(response.body.request.request_id).to.be.ok
    expect(response.body.request.source_ip).to.be.ok
    expect(response.body.request.lookup_ip).to.be.ok
    expect(response.body.status_code).to.be.ok
    expect(response.body.status_code).to.equal(200)
    expect(response.body.error).to.not.be.ok

    expect(response.body.location).to.be.ok
    expect(response.body.location.latitude).to.be.ok
    expect(response.body.location.longitude).to.be.ok
    expect(response.body.location.city_name).to.be.ok
    expect(response.body.location.region_name).to.be.ok
    expect(response.body.location.region_iso_code).to.be.ok
    expect(response.body.location.postal_code).to.be.ok
    expect(response.body.location.country_name).to.be.ok
    expect(response.body.location.country_iso_code).to.be.ok
    expect(response.body.location.continent_name).to.be.ok
    expect(response.body.location.continent_code).to.be.ok

    expect(response.body.timezone).to.be.ok
    expect(response.body.timezone.time_zone).to.be.ok
    expect(response.body.timezone.time_zone_abbr).to.be.ok
    expect(response.body.timezone.time_zone_offset).to.be.ok
    expect(response.body.timezone.time_zone_is_dst).to.be.ok
    expect(response.body.timezone.time_zone_current_time).to.be.ok

    expect(response.body.security).to.be.ok
    expect(response.body.security.is_anonymous_proxy).to.be.ok
    expect(response.body.security.is_satellite_provider).to.be.ok

    expect(response.body.isp).to.be.ok
    expect(response.body.isp.asn).to.be.ok
    expect(response.body.isp.organization).to.be.ok
}
